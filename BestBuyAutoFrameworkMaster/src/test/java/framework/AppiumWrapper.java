...
public class AppiumWrapper {
    ...
    private static AppiumDriver buildAppiumDriver() throws MalformedURLException {
        ...
        String browserstackServerURL = "http://hub-cloud.browserstack.com/wd/hub";
        String platformName = configReader.getMobilePlatformName();
        DesiredCapabilities capabilities = new DesiredCapabilities();

        //Commenting out Appium capabilities below when switching to browserstack
        ...
        //This code below only applies when running iOS tests on BrowserStack..comment out when not in use and use if/else logic below for local
        //appiumDriver = new IOSDriver(new URL(browserstackServerURL), capabilities);

        //**


        //Commenting out the if/else logic for  iOS and Android emualtor/sim for local Appium below when using Browserstack
