...
public class BasePage {
	...
	public void setNumericValue(By locator, int num) {
		webAction(locator).sendKeys(String.valueOf(num));
	}

	public void clickEnter(By locator, String value){
		webAction(locator).sendKeys(value + "\n");
	}
	public void clickEnter2(By locator){
